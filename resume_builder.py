...
class PDFResume(FPDF):
    ...
    def add_projects(self, projects):
        ...
        for project in projects:
            ...
            # Add a line break before the technologies
            self.ln(5)
            ...
            # If the total width exceeds page width, handle it
            if total_width > page_width:
                self.set_font('DejaVu', 'B', 12)
                self.cell(0, 10, technologies_label, new_x=XPos.LMARGIN, new_y=YPos.NEXT, align='L')
                self.set_font('DejaVu', '', 12)
                self.ln(5)  # Move to a new line before adding technologies
...
#         self.set_font('DejaVu', 'B', 14)
#         self.cell(0, 10, self.name, new_x=XPos.LMARGIN, new_y=YPos.NEXT, align='C')
#         self.ln(5)  # Add space after the name

#         self.set_font('DejaVu', '', 12)
#         # First line of contact information: email and phone
#         self.cell(0, 10, f"Email: {self.email} | Phone: {self.phone}", new_x=XPos.LMARGIN, new_y=YPos.NEXT, align='C')
#         self.ln(5)  # Add space after the first line of contact info

#         # Second line of contact information: LinkedIn and GitHub
#         self.cell(0, 10, f"LinkedIn: {self.linkedin} | GitHub: {self.github}", new_x=XPos.LMARGIN, new_y=YPos.NEXT, align='C')
#         self.ln(10)  # Add space after the header
